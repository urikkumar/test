   ...
   */
    paths: {
       ...
       // jquery           : 'lib/jquery',
        ...
        livequery           : 'lib/gantt4/libs/jquery.livequery.min',
        timers              : 'lib/gantt4/libs/jquery.timers',
        platform            : 'lib/gantt4/libs/platform',
        date                : 'lib/gantt4/libs/date',
        i18nJs              : 'lib/gantt4/libs/i18nJs',
        dateField           : 'lib/gantt4/libs/dateField/jquery.dateField',
        jqueryJST           : 'lib/gantt4/libs/JST/jquery.JST',
        ganttUtilities      : 'lib/gantt4/js/ganttUtilities',
        ganttTask           : 'lib/gantt4/js/ganttTask',
        ganttDrawer         : 'lib/gantt4/js/ganttDrawer',
        ganttGridEditor     : 'lib/gantt4/js/ganttGridEditor',
        ganttMaster         : 'lib/gantt4/js/ganttMaster'
    }
});
